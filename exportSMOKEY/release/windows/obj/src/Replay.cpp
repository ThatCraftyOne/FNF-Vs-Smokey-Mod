...
HXDLIN(  78)		_hx_tmp(((_hx_tmp1 + this->path) + HX_(" replay...",07,d7,a1,13)),::hx::SourceInfo(HX_("source_smokey/Replay.hx",96,91,ba,9c),78,HX_("Replay",47,5b,16,3b),HX_("LoadFromJSON",f8,e4,96,25)));
HXLINE(  79)		try {
...
HXDLIN(  86)					_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("source_smokey/Replay.hx",96,91,ba,9c),86,HX_("Replay",47,5b,16,3b),HX_("LoadFromJSON",f8,e4,96,25)));
            				}
            			}
            			else {
