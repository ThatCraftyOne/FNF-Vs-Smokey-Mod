...
HXLINE( 593)				if (::hx::IsPointerEq( input->device,::flixel::input::actions::FlxInputDevice_obj::KEYBOARD_dyn() )) {
...
void Controls_obj::addGamepad(int id, ::haxe::ds::EnumValueMap buttonMap){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_600_addGamepad)
HXLINE( 601)		this->gamepadsAdded->push(id);
HXLINE( 604)		{
HXLINE( 604)			::Dynamic map = buttonMap;
...
HXLINE( 604)				 ::Control key = _g_keys->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXDLIN( 604)				::Array< int > _g1_value = ( (::Array< int >)(::haxe::IMap_obj::get(_g_map,key)) );
HXDLIN( 604)				 ::Control _g1_key = key;
HXDLIN( 604)				 ::Control control = _g1_key;
HXDLIN( 604)				::Array< int > buttons = _g1_value;
HXLINE( 605)				{
...
void Controls_obj::addGamepadLiteral(int id, ::haxe::ds::EnumValueMap buttonMap){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_613_addGamepadLiteral)
HXLINE( 614)		this->gamepadsAdded->push(id);
HXLINE( 617)		{
HXLINE( 617)			::Dynamic map = buttonMap;
HXDLIN( 617)			::Dynamic _g_map = map;
HXDLIN( 617)			 ::Dynamic _g_keys = ::haxe::IMap_obj::keys(map);
HXDLIN( 617)			while(( (bool)(_g_keys->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 617)				 ::Control key = _g_keys->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXDLIN( 617)				::Array< int > _g1_value = ( (::Array< int >)(::haxe::IMap_obj::get(_g_map,key)) );
HXDLIN( 617)				 ::Control _g1_key = key;
HXDLIN( 617)				 ::Control control = _g1_key;
HXDLIN( 617)				::Array< int > buttons = _g1_value;
HXLINE( 618)				{
...
HXDLIN( 633)					if (::hx::IsPointerEq( input->device,::flixel::input::actions::FlxInputDevice_obj::GAMEPAD_dyn() )) {
...
HXDLIN( 644)		{
HXDLIN( 644)			::Dynamic map = _g;
HXDLIN( 644)			::Dynamic _g_map = map;
HXDLIN( 644)			 ::Dynamic _g_keys = ::haxe::IMap_obj::keys(map);
HXDLIN( 644)			while(( (bool)(_g_keys->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN( 644)				 ::Control key = _g_keys->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXDLIN( 644)				::Array< int > _g1_value = ( (::Array< int >)(::haxe::IMap_obj::get(_g_map,key)) );
HXDLIN( 644)				 ::Control _g1_key = key;
HXDLIN( 644)				 ::Control control = _g1_key;
HXDLIN( 644)				::Array< int > buttons = _g1_value;
HXDLIN( 644)				{
...
HXDLIN( 722)					_g = (_g + 1);
HXLINE( 724)					if (::hx::IsPointerEq( input->device,::flixel::input::actions::FlxInputDevice_obj::KEYBOARD_dyn() )) {
...
HXDLIN( 709)			if (::hx::IsPointerEq( input->device,::flixel::input::actions::FlxInputDevice_obj::GAMEPAD_dyn() )) {
...
HXDLIN( 750)		switch((int)(device->_hx_getIndex())){
            			case (int)0: {
HXLINE( 752)				return ::hx::IsPointerEq( input->device,::flixel::input::actions::FlxInputDevice_obj::KEYBOARD_dyn() );
            			}
            			break;
            			case (int)1: {
HXLINE( 753)				int id = device->_hx_getInt(0);
HXDLIN( 753)				if (::hx::IsPointerEq( input->device,::flixel::input::actions::FlxInputDevice_obj::GAMEPAD_dyn() )) {
HXLINE( 753)					if ((id != -1)) {
...
HXDLIN( 759)		if (::hx::IsPointerEq( input->device,::flixel::input::actions::FlxInputDevice_obj::GAMEPAD_dyn() )) {
