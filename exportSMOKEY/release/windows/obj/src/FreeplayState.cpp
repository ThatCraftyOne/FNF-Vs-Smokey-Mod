...
HXLINE( 205)			::String poop = ::StringTools_obj::replace(this->songs->__get(this->curSelected).StaticCast<  ::SongMetadata >()->songName,HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)).toLowerCase();
HXDLIN( 205)			::String poop1 = ::Highscore_obj::formatSong(poop,this->curDifficulty);
HXLINE( 207)			::haxe::Log_obj::trace(poop1,::hx::SourceInfo(HX_("source_smokey/FreeplayState.hx",4e,d8,bf,e2),207,HX_("FreeplayState",31,61,f2,b3),HX_("update",09,86,05,87)));
HXLINE( 209)			::PlayState_obj::SONG = ::Song_obj::loadFromJson(poop1,::StringTools_obj::replace(this->songs->__get(this->curSelected).StaticCast<  ::SongMetadata >()->songName,HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)).toLowerCase());
...
HXLINE( 213)			::haxe::Log_obj::trace((HX_("CUR WEEK",b4,9a,a0,36) + ::PlayState_obj::storyWeek),::hx::SourceInfo(HX_("source_smokey/FreeplayState.hx",4e,d8,bf,e2),213,HX_("FreeplayState",31,61,f2,b3),HX_("update",09,86,05,87)));
HXLINE( 214)			{
...
HXDLIN( 266)		::String song = this->songs->__get(this->curSelected).StaticCast<  ::SongMetadata >()->songName;
HXDLIN( 266)		song = ::StringTools_obj::replace(song,HX_(" ",20,00,00,00),HX_("-",2d,00,00,00));
HXDLIN( 266)		_hx_tmp2->playMusic((((HX_("songs:assets/songs/",c1,ed,e6,7e) + song.toLowerCase()) + HX_("/Inst.",f9,6e,13,1c)) + HX_("ogg",4f,94,54,00)),0,null(),null());
