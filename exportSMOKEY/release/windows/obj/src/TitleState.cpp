...
static const int _hx_array_data_8ca18d79_6[] = {
	(int)0,(int)1,(int)2,(int)3,(int)4,(int)5,(int)6,(int)7,(int)8,(int)9,(int)10,(int)11,(int)12,(int)13,(int)14,(int)15,(int)16,(int)17,(int)18,(int)19,(int)20,(int)21,
};
...
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_340_createCoolText,"TitleState","createCoolText",0x83610287,"TitleState.createCoolText","TitleState.hx",340,0xd132a6e5)
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_351_addMoreText,"TitleState","addMoreText",0xcf420fae,"TitleState.addMoreText","TitleState.hx",351,0xd132a6e5)
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_361_deleteCoolText,"TitleState","deleteCoolText",0x8afda2b6,"TitleState.deleteCoolText","TitleState.hx",361,0xd132a6e5)
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_369_beatHit,"TitleState","beatHit",0xfba69a88,"TitleState.beatHit","TitleState.hx",369,0xd132a6e5)
static const ::String _hx_array_data_8ca18d79_19[] = {
	HX_("ThatCraftyOne",86,33,53,e1),
};
...
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_446_skipIntro,"TitleState","skipIntro",0xc9924038,"TitleState.skipIntro","TitleState.hx",446,0xd132a6e5)
...
HXLINE( 442)		this->skippedIntro = false;
...
HXDLIN(  64)		_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("source_smokey/TitleState.hx",24,96,dd,e5),64,HX_("TitleState",79,8d,a1,8c),HX_("create",fc,66,0f,7c)));
...
HXLINE( 166)		this->logoBl =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,275,-50,null());
...
HXLINE( 175)		this->gfDance =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,150,null());
...
HXLINE( 177)		this->gfDance->animation->addByIndices(HX_("danceLeft",da,cc,f9,df),HX_("smokey_chill_idle",04,be,78,3c),::Array_obj< int >::fromData( _hx_array_data_8ca18d79_6,22),HX_("",00,00,00,00),30,false,null(),null());
HXLINE( 178)		this->gfDance->set_antialiasing(true);
HXLINE( 179)		this->add(this->gfDance);
HXLINE( 180)		this->add(this->logoBl);
HXLINE( 182)		this->titleText =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,150,(( (Float)(::flixel::FlxG_obj::height) ) * ((Float)0.8)),null());
...
HXLINE( 321)					::haxe::Log_obj::trace((HX_("error: ",6e,80,0a,ea) + error),::hx::SourceInfo(HX_("source_smokey/TitleState.hx",24,96,dd,e5),321,HX_("TitleState",79,8d,a1,8c),HX_("update",09,86,05,87)));
HXLINE( 322)					{
...
HXLINE( 312)				 ::sys::Http http =  ::sys::Http_obj::__alloc( HX_CTX ,HX_("https://raw.githubusercontent.com/KadeDev/Kade-Engine/master/version.downloadMe",75,a0,51,4f));
HXLINE( 315)				http->onData =  ::Dynamic(new _hx_Closure_0());
HXLINE( 320)				http->onError =  ::Dynamic(new _hx_Closure_1());
HXLINE( 325)				http->request(null());
            			}
            			HX_END_LOCAL_FUNC1((void))
...
HXLINE( 306)			::MainMenuState_obj::firstStart = true;
HXLINE( 308)			 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(2, ::Dynamic(new _hx_Closure_2()),null());
            		}
HXLINE( 330)		bool _hx_tmp2;
HXDLIN( 330)		bool _hx_tmp3;
HXDLIN( 330)		if (pressedEnter) {
HXLINE( 330)			_hx_tmp3 = !(this->skippedIntro);
            		}
            		else {
HXLINE( 330)			_hx_tmp3 = false;
            		}
HXDLIN( 330)		if (_hx_tmp3) {
HXLINE( 330)			_hx_tmp2 = ::TitleState_obj::initialized;
            		}
            		else {
HXLINE( 330)			_hx_tmp2 = false;
            		}
HXDLIN( 330)		if (_hx_tmp2) {
HXLINE( 332)			this->skipIntro();
            		}
...
void TitleState_obj::createCoolText(::Array< ::String > textArray){
            	HX_GC_STACKFRAME(&_hx_pos_a55214e0452daa02_340_createCoolText)
HXDLIN( 340)		int _g = 0;
HXDLIN( 340)		int _g1 = textArray->length;
HXDLIN( 340)		while((_g < _g1)){
HXDLIN( 340)			_g = (_g + 1);
HXDLIN( 340)			int i = (_g - 1);
HXLINE( 342)			 ::Alphabet money =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),textArray->__get(i),true,false,null());
HXLINE( 343)			money->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE( 344)			money->set_y((money->y + ((i * 60) + 200)));
HXLINE( 345)			this->credGroup->add(money).StaticCast<  ::flixel::FlxBasic >();
HXLINE( 346)			this->textGroup->add(money).StaticCast<  ::flixel::FlxBasic >();
            		}
            	}
...
void TitleState_obj::addMoreText(::String text){
            	HX_GC_STACKFRAME(&_hx_pos_a55214e0452daa02_351_addMoreText)
HXLINE( 352)		 ::Alphabet coolText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),text,true,false,null());
HXLINE( 353)		coolText->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE( 354)		coolText->set_y((coolText->y + ((this->textGroup->length * 60) + 200)));
HXLINE( 355)		this->credGroup->add(coolText).StaticCast<  ::flixel::FlxBasic >();
HXLINE( 356)		this->textGroup->add(coolText).StaticCast<  ::flixel::FlxBasic >();
            	}
...
void TitleState_obj::deleteCoolText(){
            	HX_STACKFRAME(&_hx_pos_a55214e0452daa02_361_deleteCoolText)
HXDLIN( 361)		while((this->textGroup->members->get_length() > 0)){
HXLINE( 363)			this->credGroup->remove(Dynamic( this->textGroup->members->__get(0)).StaticCast<  ::flixel::FlxBasic >(),true).StaticCast<  ::flixel::FlxBasic >();
HXLINE( 364)			this->textGroup->remove(Dynamic( this->textGroup->members->__get(0)).StaticCast<  ::flixel::FlxBasic >(),true).StaticCast<  ::flixel::FlxBasic >();
            		}
            	}
...
void TitleState_obj::beatHit(){
            	HX_STACKFRAME(&_hx_pos_a55214e0452daa02_369_beatHit)
HXLINE( 370)		this->super::beatHit();
HXLINE( 372)		this->logoBl->animation->play(HX_("bump",f6,0f,20,41),null(),null(),null());
HXLINE( 373)		this->danceLeft = !(this->danceLeft);
HXLINE( 375)		if (this->danceLeft) {
HXLINE( 376)			this->gfDance->animation->play(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            		}
            		else {
HXLINE( 378)			this->gfDance->animation->play(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            		}
HXLINE( 382)		switch((int)(this->curBeat)){
            			case (int)1: {
HXLINE( 385)				this->createCoolText(::Array_obj< ::String >::fromData( _hx_array_data_8ca18d79_19,1));
            			}
            			break;
            			case (int)3: {
HXLINE( 388)				this->addMoreText(HX_("presents",18,61,d7,66));
            			}
            			break;
            			case (int)4: {
HXLINE( 392)				this->deleteCoolText();
            			...
            			break;
            			case (int)5: {
HXLINE( 397)				if (::Main_obj::watermarks) {
HXLINE( 398)					this->createCoolText(::Array_obj< ::String >::fromData( _hx_array_data_8ca18d79_20,2));
            				}
            				else {
HXLINE( 400)					this->createCoolText(::Array_obj< ::String >::fromData( _hx_array_data_8ca18d79_21,2));
            				}
            			}
            			break;
            			case (int)7: {
HXLINE( 402)				if (::Main_obj::watermarks) {
HXLINE( 403)					this->addMoreText(HX_("KadeDeveloper",93,41,22,2c));
            				}
            				else {
HXLINE( 406)					this->addMoreText(HX_("Newgrounds",cc,13,58,ed));
HXLINE( 407)					this->ngSpr->set_visible(true);
            				}
            			}
            			break;
            			case (int)8: {
HXLINE( 411)				this->deleteCoolText();
HXLINE( 412)				this->ngSpr->set_visible(false);
            			}
            			break;
            			case (int)9: {
HXLINE( 418)				this->createCoolText(::Array_obj< ::String >::__new(1)->init(0,this->curWacky->__get(0)));
            			}
            			break;
            			case (int)11: {
HXLINE( 421)				this->addMoreText(this->curWacky->__get(1));
            			}
            			break;
            			case (int)12: {
HXLINE( 424)				this->deleteCoolText();
            			...
            			break;
            			case (int)13: {
HXLINE( 429)				this->addMoreText(HX_("Vs",5d,4b,00,00));
            			}
            			break;
            			case (int)14: {
HXLINE( 432)				this->addMoreText(HX_("Smokey",4a,66,fc,3b));
            			}
            			break;
            			case (int)15: {
HXLINE( 435)				this->addMoreText(HX_("Mod",a2,ce,3a,00));
            			}
            			break;
            			case (int)16: {
HXLINE( 438)				this->skipIntro();
            			}
            			break;
            		}
            	}
...
void TitleState_obj::skipIntro(){
            	HX_STACKFRAME(&_hx_pos_a55214e0452daa02_446_skipIntro)
HXDLIN( 446)		if (!(this->skippedIntro)) {
...
HXLINE( 452)			this->skippedIntro = true;
            		}
            	}
