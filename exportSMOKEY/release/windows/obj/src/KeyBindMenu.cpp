...
HXLINE( 228)		::haxe::Log_obj::trace(notAllowed,::hx::SourceInfo(HX_("source_smokey/KeyBindMenu.hx",e4,de,f9,3c),228,HX_("KeyBindMenu",9b,9e,7a,e2),HX_("addKey",fe,99,02,9f)));
HXLINE( 230)		{
