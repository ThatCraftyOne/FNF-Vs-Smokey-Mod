...
HXLINE(  30)			::haxe::Log_obj::trace(HX_("No UP",ba,80,b8,32),::hx::SourceInfo(HX_("source_smokey/KeyBinds.hx",86,4a,43,b5),30,HX_("KeyBinds",17,72,1b,d1),HX_("keyCheck",a9,3e,20,8a)));
            		}
...
HXLINE(  34)			::haxe::Log_obj::trace(HX_("No DOWN",81,8c,28,a7),::hx::SourceInfo(HX_("source_smokey/KeyBinds.hx",86,4a,43,b5),34,HX_("KeyBinds",17,72,1b,d1),HX_("keyCheck",a9,3e,20,8a)));
            		}
...
HXLINE(  38)			::haxe::Log_obj::trace(HX_("No LEFT",26,9c,6a,ac),::hx::SourceInfo(HX_("source_smokey/KeyBinds.hx",86,4a,43,b5),38,HX_("KeyBinds",17,72,1b,d1),HX_("keyCheck",a9,3e,20,8a)));
            		}
...
HXLINE(  42)			::haxe::Log_obj::trace(HX_("No RIGHT",bd,12,eb,a7),::hx::SourceInfo(HX_("source_smokey/KeyBinds.hx",86,4a,43,b5),42,HX_("KeyBinds",17,72,1b,d1),HX_("keyCheck",a9,3e,20,8a)));
            		}
...
HXLINE(  46)			::haxe::Log_obj::trace(HX_("No KILL",bd,73,c4,ab),::hx::SourceInfo(HX_("source_smokey/KeyBinds.hx",86,4a,43,b5),46,HX_("KeyBinds",17,72,1b,d1),HX_("keyCheck",a9,3e,20,8a)));
            		}
            	}
