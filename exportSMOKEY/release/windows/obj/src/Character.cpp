...
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_611_dance,"Character","dance",0xde4da48e,"Character.dance","Character.hx",611,0xf073a2d5)
...
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_703_addOffset,"Character","addOffset",0x6dc9376f,"Character.addOffset","Character.hx",703,0xf073a2d5)
...
HXDLIN( 527)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("smokey/smokeyalien_assets",2a,55,ef,8d)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 527)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("smokey/smokeyalien_assets",2a,55,ef,8d)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 529)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("smokeyalien_idle_a",d8,eb,a5,a6),30,false,null(),null());
HXLINE( 530)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("smokeyalien_up_b",60,7e,be,07),30,false,null(),null());
HXLINE( 531)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("smokeyalien_right_b",1d,17,9d,c1),30,false,null(),null());
HXLINE( 532)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("smokeyalien_left_b",8c,af,32,69),30,false,null(),null());
HXLINE( 533)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("smokeyalien_down_b",a7,ac,91,03),30,false,null(),null());
HXLINE( 534)			this->animation->addByPrefix(HX_("idleAlt",75,ae,38,7c),HX_("smokeyalien_tired_a",3c,9e,28,68),30,false,null(),null());
HXLINE( 536)			this->addOffset(HX_("idle",14,a7,b3,45),null(),null());
HXLINE( 537)			this->addOffset(HX_("singUP",6a,52,21,b9),0,38);
HXLINE( 538)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),null(),null());
HXLINE( 539)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),null(),null());
HXLINE( 540)			this->addOffset(HX_("singDOWN",31,2a,ad,36),null(),null());
HXLINE( 541)			this->addOffset(HX_("idleAlt",75,ae,38,7c),null(),null());
HXLINE( 543)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
...
HXLINE( 273)			::haxe::Log_obj::trace(tex1->frames->length,::hx::SourceInfo(HX_("source_smokey/Character.hx",76,a0,66,d0),273,HX_("Character",89,bb,a4,e3),HX_("new",60,d0,53,00)));
...
HXDLIN( 504)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("smokey/smokey_assets",53,57,e1,29)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 504)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("smokey/smokey_assets",53,57,e1,29)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 506)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("smokey_idle_a",eb,ff,52,1b),30,false,null(),null());
HXLINE( 507)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("smokey_up_b",b3,57,44,ec),30,false,null(),null());
HXLINE( 508)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("smokey_right_b",aa,93,61,64),30,false,null(),null());
HXLINE( 509)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("smokey_left_b",9f,c3,df,dd),30,false,null(),null());
HXLINE( 510)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("smokey_down_b",ba,c0,3e,78),30,false,null(),null());
HXLINE( 511)			this->animation->addByPrefix(HX_("idle-alt",30,54,1f,28),HX_("smokey_chill_idle",04,be,78,3c),30,false,null(),null());
HXLINE( 512)			this->animation->addByPrefix(HX_("singUP-alt",86,62,b4,5f),HX_("smokey_pained_b",4d,d0,26,e9),30,false,null(),null());
HXLINE( 515)			this->addOffset(HX_("idle",14,a7,b3,45),null(),null());
HXLINE( 516)			this->addOffset(HX_("singUP",6a,52,21,b9),null(),null());
HXLINE( 517)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),5,0);
HXLINE( 518)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),-5,0);
HXLINE( 519)			this->addOffset(HX_("singDOWN",31,2a,ad,36),0,-2);
HXLINE( 520)			this->addOffset(HX_("idle-alt",30,54,1f,28),null(),null());
HXLINE( 521)			this->addOffset(HX_("singUP-alt",86,62,b4,5f),null(),null());
...
HXLINE( 588)				::haxe::Log_obj::trace(HX_("dance",33,83,83,d4),::hx::SourceInfo(HX_("source_smokey/Character.hx",76,a0,66,d0),588,HX_("Character",89,bb,a4,e3),HX_("update",09,86,05,87)));
HXLINE( 589)				this->dance();
HXLINE( 590)				this->holdTimer = ( (Float)(0) );
            			}
            		}
HXLINE( 594)		if ((this->curCharacter == HX_("gf",1f,5a,00,00))) {
HXLINE( 597)			bool _hx_tmp;
HXDLIN( 597)			if ((this->animation->_curAnim->name == HX_("hairFall",bd,48,d6,cb))) {
HXLINE( 597)				_hx_tmp = this->animation->_curAnim->finished;
            			}
            			else {
...
HXLINE( 601)		this->super::update(elapsed);
            	}


void Character_obj::dance(){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_611_dance)
HXDLIN( 611)		if (!(this->debugMode)) {
HXLINE( 613)			::String _hx_switch_0 = this->curCharacter;
            			if (  (_hx_switch_0==HX_("gf",1f,5a,00,00)) ){
HXLINE( 616)				if (!(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("hair",22,27,08,45)))) {
HXLINE( 618)					this->danced = !(this->danced);
HXLINE( 620)					if (this->danced) {
HXLINE( 621)						this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            					}
            					else {
HXLINE( 623)						this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            					}
            				}
HXLINE( 616)				goto _hx_goto_21;
            			}
            			if (  (_hx_switch_0==HX_("gf-car",a6,63,ab,07)) ){
...
HXLINE( 638)				goto _hx_goto_21;
            			...
            			if (  (_hx_switch_0==HX_("gf-christmas",94,26,b1,6d)) ){
HXLINE( 627)				if (!(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("hair",22,27,08,45)))) {
HXLINE( 629)					this->danced = !(this->danced);
HXLINE( 631)					if (this->danced) {
HXLINE( 632)						this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            					}
            					else {
HXLINE( 634)						this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            					}
            				}
HXLINE( 627)				goto _hx_goto_21;
            			}
            			if (  (_hx_switch_0==HX_("gf-pixel",98,3e,8c,55)) ){
HXLINE( 648)				if (!(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("hair",22,27,08,45)))) {
HXLINE( 650)					this->danced = !(this->danced);
HXLINE( 652)					if (this->danced) {
HXLINE( 653)						this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            					}
            					else {
HXLINE( 655)						this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            					}
            				}
HXLINE( 648)				goto _hx_goto_21;
            			}
            			if (  (_hx_switch_0==HX_("spooky",eb,bd,9e,c1)) ){
HXLINE( 659)				this->danced = !(this->danced);
HXLINE( 661)				if (this->danced) {
HXLINE( 662)					this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            				}
            				else {
HXLINE( 664)					this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            				}
HXLINE( 658)				goto _hx_goto_21;
            			}
            			/* default */{
HXLINE( 666)				this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
            			}
            			_hx_goto_21:;
            		}
            	}
...
HXLINE( 673)		this->animation->play(AnimName,Force,Reversed,Frame);
HXLINE( 675)		::cpp::VirtualArray daOffset = ( (::cpp::VirtualArray)(this->animOffsets->get(AnimName)) );
HXLINE( 676)		if (this->animOffsets->exists(AnimName)) {
HXLINE( 678)			this->offset->set(daOffset->__get(0),daOffset->__get(1));
            		}
            		else {
HXLINE( 681)			this->offset->set(0,0);
            		}
HXLINE( 683)		if ((this->curCharacter == HX_("gf",1f,5a,00,00))) {
HXLINE( 685)			if ((AnimName == HX_("singLEFT",d6,39,ef,3b))) {
HXLINE( 687)				this->danced = true;
            			}
            			else {
HXLINE( 689)				if ((AnimName == HX_("singRIGHT",0d,6f,70,ac))) {
HXLINE( 691)					this->danced = false;
            				}
            			}
HXLINE( 694)			bool _hx_tmp;
HXDLIN( 694)			if ((AnimName != HX_("singUP",6a,52,21,b9))) {
HXLINE( 694)				_hx_tmp = (AnimName == HX_("singDOWN",31,2a,ad,36));
            			}
            			else {
HXLINE( 694)				_hx_tmp = true;
            			}
HXDLIN( 694)			if (_hx_tmp) {
HXLINE( 696)				this->danced = !(this->danced);
            			}
            		}
            	}
...
void Character_obj::addOffset(::String name,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            	...
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_703_addOffset)
HXDLIN( 703)		::cpp::VirtualArray v = ::Array_obj< Float >::__new(2)->init(0,x)->init(1,y);
HXDLIN( 703)		this->animOffsets->set(name,v);
            	}
