...
class PlayState extends MusicBeatState
{
	...
	public static var smokey:Character;
	public static var alien:Character;
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'starry':
				dialogue = CoolUtil.coolTextFile(Paths.txt('starry/starryDialogue'));
			case 'city':
				dialogue = CoolUtil.coolTextFile(Paths.txt('city/cityDialogue'));
			case 'abduction':
				dialogue = CoolUtil.coolTextFile(Paths.txt('city/cityDialogue'));
		}
		...
		switch(SONG.stage)
		{
			...
			case 'smokeyStage':
			{
						curStage = 'smokeyStage';
						defaultCamZoom = 0.9;
						var bg:FlxSprite = new FlxSprite(-300, -100);
						bg.loadGraphic(Paths.image('smokey/background_assets'));
						add(bg);
						bg.active = false;
						bg.updateHitbox();
						bg.antialiasing = true;
			...
			case 'stage':
				{
						defaultCamZoom = 0.9;
						curStage = 'stage';
						var bg:FlxSprite = new FlxSprite(-1175, -800).loadGraphic(Paths.image('smokey/background_assets'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						bg.scale.set(.5, .5);
	...
	private function generateStaticArrows(player:Int):Void
	{
		for (i in 0...4)
		{
			...
			{
				case 'pixel':
					babyArrow.frames = Paths.getSparrowAtlas('smokey/NOTE_assets_smokey');
	...
	*/
	...
	override function beatHit()
	{
		...
		if (curStep == 1016 && curSong == 'Abduction')
		{
			defaultCamZoom = 1.4;
		}

		if (curStep == 1024 && curSong == 'Abduction')
		{
			defaultCamZoom = 0.9;
			// alien.playAnim('idleAlt');
		}
